...
warnings.warn(
    "DocumentProcessor is DEPRECATED. The active document layer is sage_document_db. "
    "Do not use DocumentProcessor in new code.",
    DeprecationWarning,
    stacklevel=2,
)
...
class DocumentProcessor:
    """
    [DEPRECATED] Legacy document processor that reparsed documents on demand.
    Replaced by sage_document_db (Docling, canonical artifact storage, Chroma RAG).
    Retained temporarily only for backwards-compatibility testing.
    """
